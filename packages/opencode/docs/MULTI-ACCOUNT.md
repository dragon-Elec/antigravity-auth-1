...
For checking quotas outside of OpenCode (for debugging, CI, etc.), use the
in-app **Check quotas** menu shown above. There is no longer a standalone
script shipped with the plugin.
